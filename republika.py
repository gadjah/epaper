...
def main():
    ...
    mainPage = "http://epaper.%s.co.id" % (web)
    log(mainPage)
    ...
    loginPage = 'http://%s.pressmart.com/ajax/EpaperLibrary.AjaxUtilsMethods,EpaperLibrary.ashx?_method=CheckLoginCredentialsNew&_session=rw' % (web)
    ...
    Url = "http://%s.pressmart.com/PUBLICATIONS/RP/RP/%s/%s/%s/PagePrint/" % (web, year, month, date)
